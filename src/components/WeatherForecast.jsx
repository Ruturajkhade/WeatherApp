    ...
    return (
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
                {/* Map Method Logic */}
                <div className="flex items-center justify-between p-5 bg-white/5 backdrop-blur-sm rounded-2xl hover:bg-white/10 
                transition-all duration-300 group border border-white/10">
                    <div className="flext items-center space-x-5 flex-1">
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        <div className="text-right">
                            <div className="text-white font-bold text-xl">Temperature</div>
                            <div className="text-white text-sm font-medium">Main Temp</div>
                        </div>
                    </div>
                </div>
            </div>
